...
export default function ExerciseForm({ exercise, register, watch, errors, setValue }: ExerciseFormProps) {
    ...
    return (
        <>
            ...
            <div className="w-full mx-auto mt-1 p-2 bg-transparent rounded-lg shadow-md border border-gray-300">
                <label className="text-sm text-red-500 mb-2 ml-1 block">
                    Assign to routine(s)
                </label>
            ...
            {exercise?.exerciseImage && (
                <div className="max-w-xl mx-auto mt-1 p-2 bg-transparent rounded-lg shadow-md border border-gray-300">
