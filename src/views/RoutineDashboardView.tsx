...
export default function RoutineDashboardView() {
  ...
  if (data) return (
    <>
      ...
      <p className="text-2xl font-light mt-5 text-center">Here you can manage your workout routines</p>
      ...
      {data.length ? (
        ...
        <p className="text-center py-20">No routines yet {''}
          <Link
            className="text-red-600 hover:underline"
            to={'/routines/new'}
          >Register routine</Link>
        </p>
      )}
    </>
  )
