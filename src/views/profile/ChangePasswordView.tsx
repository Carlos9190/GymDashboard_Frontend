    ...
    return (
        <>
            <div className="w-full max-w-2xl mx-auto px-4 sm:px-6 lg:px-0">
                ...
                <p className="text-lg sm:text-xl lg:text-2xl font-light text-center mt-4 sm:mt-5">
                ...
                >
                    <div className="relative w-full">
                        <input
                            ...
                            type="password"
                            placeholder=" "
                            className={`peer w-full px-3 pt-6 pb-2 border rounded-lg bg-transparent text-white placeholder-transparent transition-all text-base sm:text-lg ${errors.current_password ? "border-red-500" : "border-gray-300"} focus:outline-none focus:border-red-500`}
                    ...
                    <div className="relative w-full">
                        <input
                            ...
                            type="password"
                            placeholder=" "
                            className={`peer w-full px-3 pt-6 pb-2 border rounded-lg bg-transparent text-white placeholder-transparent transition-all text-base sm:text-lg ${errors.password ? "border-red-500" : "border-gray-300"} focus:outline-none focus:border-red-500`}
                            {...register("password", {
                    ...
                    <div className="relative w-full">
                        <input
                            ...
                            type="password"
                            placeholder=" "
                            className={`peer w-full px-3 pt-6 pb-2 border rounded-lg bg-transparent text-white placeholder-transparent transition-all text-base sm:text-lg ${errors.password_confirmation ? "border-red-500" : "border-gray-300"} focus:outline-none focus:border-red-500`}
