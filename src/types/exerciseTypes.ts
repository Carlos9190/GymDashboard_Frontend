import { z } from "zod"
import { exerciseByIdSchema, exerciseDashboardSchema, exerciseOrderSchema, exerciseSchema } from "../schemas"
...
export type ExerciseCard = Pick<Exercise, '_id' | 'exerciseImage' | 'exerciseName'>